...
if __name__ == "__main__":
    ...
    files = [   '../test-networks/max_n/trained_safe_3_eps_0.1.spec', 
                ...
                '../test-networks/max_n/trained_safe_4_eps_0.1.spec', 
                '../test-networks/max_n/trained_safe_4_eps_0.3.spec', 
                '../test-networks/max_n/trained_safe_4_eps_0.5.spec', 
                '../test-networks/max_n/trained_safe_4_eps_0.7.spec', 
                '../test-networks/max_n/trained_safe_4_eps_0.9.spec', 
